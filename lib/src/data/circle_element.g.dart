...
part of 'circle_element.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

CircleElement _$CircleElementFromJson(Map<String, dynamic> json) {
  return CircleElement(
    r: const LengthConverter().fromJson(json['r'] as String?),
    cx: const LengthConverter().fromJson(json['cx'] as String?),
    cy: const LengthConverter().fromJson(json['cy'] as String?),
  )
...
Map<String, dynamic> _$CircleElementToJson(CircleElement instance) =>
    <String, dynamic>{
      'id': instance.id,
      'lang': instance.lang,
      ...
      'r': const LengthConverter().toJson(instance.r),
      'cx': const LengthConverter().toJson(instance.cx),
      'cy': const LengthConverter().toJson(instance.cy),
    };
