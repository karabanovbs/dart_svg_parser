...
part 'circle_element.g.dart';

@JsonSerializable()
class CircleElement implements CoreAttributes, PresentationAttributes {
  CircleElement({
    required this.r,
    required this.cx,
    required this.cy,
  ...
  factory CircleElement.fromJson(Map<String, dynamic> json) =>
      _$CircleElementFromJson(json);

  Map<String, dynamic> toJson() => _$CircleElementToJson(this);
}
